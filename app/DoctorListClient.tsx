...
function DoctorListClient() {
    const router = useRouter();
    const pathname = usePathname();
    const searchParams = useSearchParams(); // This hook requires the client component

    const [allDoctors, setAllDoctors] = useState<Doctor[]>([]);
    const [filteredDoctors, setFilteredDoctors] = useState<Doctor[]>([]);
    const [specialties, setSpecialties] = useState<string[]>([]);
    const [loading, setLoading] = useState<boolean>(true); // Keep loading state managed here
    ...
    }, [searchTerm, selectedConsultationType, selectedSpecialties, selectedSort, pathname, router, searchParams, loading]);
            ...
            <main className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <aside className="md:col-span-1 bg-white p-4 rounded-lg shadow-md h-fit">
                    ...
                    <div className="mb-5">
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="consultationType" value="Video Consult" checked={selectedConsultationType === 'Video Consult'} onChange={handleConsultationChange} data-testid="filter-video-consult" className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> Video Consult
                            </label>
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="consultationType" value="In Clinic" checked={selectedConsultationType === 'In Clinic'} onChange={handleConsultationChange} data-testid="filter-in-clinic" className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> In Clinic
                            </label>
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="consultationType" value="" checked={selectedConsultationType === ''} onChange={handleConsultationChange} className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> All
                            </label>
                        </div>
                    </div>
                    <div className="mb-5">
                        ...
                        <div className="space-y-2 max-h-60 overflow-y-auto border rounded-md p-2 pr-1">
                            {specialties.length > 0 ? specialties.map((spec, index) => (
                                <label key={`${spec}-${index}`} className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                    <input type="checkbox" value={spec} checked={selectedSpecialties.includes(spec)} onChange={handleSpecialtyChange} data-testid={getSpecialtyTestId(spec)} className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"/> {spec}
                                </label>
                    ...
                    <div>
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="sortBy" value="" checked={selectedSort === ''} onChange={handleSortChange} className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> Default
                            </label>
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="sortBy" value="fees" checked={selectedSort === 'fees'} onChange={handleSortChange} data-testid="sort-fees" className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> Fees (Low to High)
                            </label>
                            <label className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer">
                                <input type="radio" name="sortBy" value="experience" checked={selectedSort === 'experience'} onChange={handleSortChange} data-testid="sort-experience" className="mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"/> Experience (High to Low)
                            </label>
                        </div>
                    </div>
                </aside>
                    ...
                    {!loading && !error && (
                        <div className="grid grid-cols-1 gap-4">
                            {filteredDoctors.length > 0 ? (
                                ...
                                <div className="bg-white rounded-lg shadow-sm p-8 text-center md:col-span-3"> {/* Adjusted span for empty state */}
